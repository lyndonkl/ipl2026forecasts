# Sunrisers Hyderabad (SRH) — IPL 2026
...
- **Captain:** Pat Cummins (AUS) — may miss opening matches
- **Interim Captain:** Ishan Kishan (while Cummins unavailable)
- **Vice-Captain:** Abhishek Sharma
- **Home venue:** Rajiv Gandhi International Cricket Stadium, Hyderabad
- **IPL titles:** 1 (2016)
...
Ishan Kishan (wk), Travis Head (AUS), Abhishek Sharma, Heinrich Klaasen
(SA), Kamindu Mendis (SL), Liam Livingstone (ENG), R. Smaran,
Aman Rao, Praful Hinge

### All-rounders
Nitish Kumar Reddy, Brydon Carse (ENG), Sai Kishore, Harsh Dubey,
Shivang Kumar, Salil Arora

### Bowlers
Pat Cummins (c, AUS), Harshal Patel, Jaydev Unadkat, Shivam Mavi,
Eshan Malinga, Zeeshan Ansari, Sakib Hussain, David Payne (ENG,
replacement for Jack Edwards), Onkar Tarmale, Amit Kumar, Aniket Verma

### Key signings
- Liam Livingstone (ENG) — INR 13 cr
- Kamindu Mendis (SL) — emerging star

### Injuries / Availability
- Pat Cummins: missed Match 1 (back injury), Ishan Kishan captained
- Jack Edwards: ruled out (foot injury) — replaced by David Payne
...
| # | Player | Role |
|---|--------|------|
| 1 | Abhishek Sharma | Opener (LHB) — aggressive |
| 2 | Travis Head | Opener (LHB) — explosive |
...
| 9 | Harshal Patel | Death bowling specialist |
| 10 | Brydon Carse / Jaydev Unadkat | Pace |
| 11 | Shivam Mavi | Right-arm fast |

**Overseas 4:** Cummins + Head + Klaasen are locks (when Cummins
available). 4th = Livingstone, Mendis, or Carse by conditions.
When Cummins unavailable: Head, Klaasen, Livingstone/Mendis, Carse.
...
### Batting approach
SRH's identity since 2024 has been ultra-aggressive batting. Head and
Abhishek Sharma form a devastating left-handed opening pair. Klaasen
is one of the most destructive finishers in world cricket. Livingstone
adds another power option. This team can post 220+ on their day — or
collapse to 130 if the approach backfires.

### Bowling approach
Cummins provides control and leadership. Harshal Patel is an excellent
death bowler (slower balls, yorkers). Nitish Kumar Reddy offers 2–3
overs of seam. Spin is a weakness — Sai Kishore is a containing option
but not a frontline wicket-taker.

---

## Strengths

- **Explosive batting:** Head, Abhishek, Klaasen, Livingstone — multiple
  match-winners who can destroy any bowling attack.
- **Klaasen's finishing:** Among the best in the world at SR 175+ in
  death overs.
- **Harshal Patel's death bowling:** Experienced, accurate death-over
  specialist.

## Vulnerabilities

- **Boom or bust:** Ultra-aggressive approach means high variance. When
  top order fires, SRH are devastating. When it fails, they can be
  bowled out for 120.
- **Spin bowling weakness:** No frontline spinner of Varun/Kuldeep/
  Rashid calibre. Sai Kishore is reliable but not a match-winner.
- **Left-hand heavy top 3:** Abhishek, Head, and Ishan are all LHB.
  Right-arm off-spin and left-arm seam angles exploit this lineup.
- **Cummins' availability:** If Cummins misses multiple matches, the
  bowling attack loses its leader and best new-ball option.

---

## Home Venue Fit

Hyderabad offers balanced conditions — suits SRH's batting approach
without being as extreme as Chinnaswamy. Large outfield means SRH's
power hitters may find some sixes caught on the boundary that would
clear at smaller grounds.

---

## Recent Seasons

- **IPL 2025:** Mid-table performance.
- **IPL 2024:** Runners-up. Lost to KKR in the final. Highest run-
  scoring team in the tournament — Head and Abhishek were dominant.
...
| 7 (Game 017) | PBKS | Lost by 6 wkts | 219/6 in 20 ov | Abhishek 74(28) SR 264, Head 38(23) | Elite PP assault: Abhishek 74(28) + Head 38(23) = 105/0 in 6 ov (form reversal from −28% dip prediction). Klaasen 39(24), Ishan 27(17). Early-Middle swing: Shashank Singh removed both openers overs 10-11. SRH reached 219/6 but PBKS chased efficiently in 18.5 ov. Record: 2W-2L (4 pts). [Game file](../../games/game-017-PBKS-vs-SRH-2026-04-11/) |
